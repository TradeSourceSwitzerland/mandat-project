...
+    response.set_cookie("auth_token", token, httponly=True, secure=True, samesite="None", max_age=30*24*60*60)  # 30 Tage
+    # UI-Cookies für bestehende Webflow-Embeds
+    response.set_cookie("zevix_email", session["email"], secure=True, samesite="None", max_age=30*24*60*60)
+    response.set_cookie("plan", session["plan"], secure=True, samesite="None", max_age=30*24*60*60)
+
+    return response
+
+
